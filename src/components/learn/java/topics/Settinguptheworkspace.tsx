...
export default function Settinguptheworkspace() {
  ...
  const subtopics = [
    {
        "id": "installing-jdk",
        "title": "Installing and verifying the JDK",
        "description": "Download and install Java Development Kit"
    },
    {
        "id": "configuring-ide",
        "title": "Configuring the development environment",
        "description": "Set up IntelliJ IDEA for Java development"
    },
    {
        "id": "project-structure",
        "title": "Project structure and file organization",
        "description": "Learn proper Java project organization"
    },
    {
        "id": "compilation-and-execution",
        "title": "Compilation and program execution",
        "description": "Compile and run your first Java programs"
    }
];

  const handleSubtopicClick = (subtopicId: string) => {
    navigate(`/learn/java/setting-up-workspace/${subtopicId}`);
  };
