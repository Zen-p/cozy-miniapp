...
export default function Inputhandling() {
  ...
  const subtopics = [
    {
        "id": "scanner-class",
        "title": "The Scanner class and its capabilities",
        "description": "Reading input from various sources"
    },
    {
        "id": "reading-console-input",
        "title": "Reading data from the console",
        "description": "Getting user input"
    },
    {
        "id": "processing-user-input",
        "title": "Processing user input",
        "description": "Validating and handling input"
    },
    {
        "id": "simple-calculator",
        "title": "Example: simple calculator implementation",
        "description": "Building a basic calculator"
    }
];

  const handleSubtopicClick = (subtopicId: string) => {
    navigate(`/learn/java/input-handling/${subtopicId}`);
  };
