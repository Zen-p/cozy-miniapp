...
export default function Methods() {
  ...
  const subtopics = [
    {
        "id": "method-structure",
        "title": "Purpose and structure of a method",
        "description": "Understanding method anatomy"
    },
    {
        "id": "method-signature",
        "title": "Method signature: parameters and return type",
        "description": "Defining method contracts"
    },
    {
        "id": "passing-arguments",
        "title": "Passing arguments to methods",
        "description": "How parameters work in Java"
    },
    {
    ...
    {
        "id": "static-keyword",
        "title": "The static keyword and its usage",
        "description": "Static methods and variables"
    },
    {
        "id": "method-variable-scope",
        "title": "Variable scope within a method",
        "description": "Local variables and scope"
    }
];

  const handleSubtopicClick = (subtopicId: string) => {
    navigate(`/learn/java/methods/${subtopicId}`);
  };
