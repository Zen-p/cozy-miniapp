...
export default function Arrays() {
  ...
  const subtopics = [
    {
        "id": "array-creation",
        "title": "Creation and initialization of arrays",
        "description": "Declaring and initializing arrays"
    },
    {
        "id": "multidimensional-arrays",
        "title": "One-dimensional and multidimensional arrays",
        "description": "Working with array dimensions"
    },
    {
        "id": "iterating-arrays",
        "title": "Iterating over arrays",
        "description": "for, for-each loops with arrays"
    },
    {
        "id": "arrays-class-methods",
        "title": "The Arrays class and its methods",
        "description": "Utility methods for array operations"
    },
    {
        "id": "array-limitations",
        "title": "Features and limitations of arrays",
        "description": "Understanding array constraints"
    }
];

  const handleSubtopicClick = (subtopicId: string) => {
    navigate(`/learn/java/arrays/${subtopicId}`);
  };
