...
export default function Errorsanddebugging() {
  ...
  const subtopics = [
    {
        ...
        "description": "Syntax, logical, runtime errors"
    },
    {
    ...
    },
    {
        ...
        "description": "Throwable, Exception, RuntimeException"
    },
    {
        "id": "try-catch-finally",
        "title": "Try, catch, and finally blocks",
        "description": "Handling exceptions properly"
    },
    {
        "id": "debugging-techniques",
        "title": "Basic debugging techniques in the IDE",
        "description": "Breakpoints, step execution, variable inspection"
    }
];

  const handleSubtopicClick = (subtopicId: string) => {
    navigate(`/learn/java/errors-and-debugging/${subtopicId}`);
  };
