...
export default function Controlflowstatements() {
  ...
  const subtopics = [
    ...
    },
    {
        "id": "loops",
        "title": "Loops",
        "description": "for, while, do-while, for-each loops"
    },
    {
        "id": "control-flow-operators",
        "title": "Control flow operators",
        "description": "break, continue operators"
    },
    {
        "id": "break-in-nested-loops",
  ...
  const handleSubtopicClick = (subtopicId: string) => {
    navigate(`/learn/java/control-flow-statements/${subtopicId}`);
  };
