...
export default function Commandsandthefirstprogram() {
  ...
  const subtopics = [
    ...
    {
        "id": "class-and-main-method",
        "title": "Class and the main method",
        "description": "Learn about classes and the main entry point"
    },
    {
        "id": "console-output",
        "title": "Output to the console",
        "description": "Using System.out.println for output"
    }
];

  const handleSubtopicClick = (subtopicId: string) => {
    navigate(`/learn/java/commands-and-first-program/${subtopicId}`);
  };
