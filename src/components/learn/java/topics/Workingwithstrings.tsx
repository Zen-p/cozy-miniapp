...
export default function Workingwithstrings() {
  ...
  const subtopics = [
    {
        "id": "string-literals",
        "title": "String literals and escape sequences",
        "description": "Working with text in Java"
    },
    {
        "id": "string-class-methods",
        "title": "The String class and its main methods",
        "description": "Common string manipulation methods"
    },
    {
        "id": "string-immutability",
        "title": "String immutability",
        "description": "Understanding why strings are immutable"
    },
    {
        "id": "concatenation-performance",
        "title": "Concatenation and performance considerations",
        "description": "Efficient string operations"
    },
    {
        "id": "stringbuilder-and-buffer",
        "title": "Using StringBuilder and StringBuffer",
        "description": "Mutable string alternatives"
    },
    {
        "id": "wrapper-classes",
        "title": "Wrapper classes for primitive types",
        "description": "Integer, Double, Boolean classes"
    },
    {
        "id": "memory-management",
        "title": "Basics of memory management",
        "description": "Heap, stack, references in Java"
    }
];

  const handleSubtopicClick = (subtopicId: string) => {
    navigate(`/learn/java/working-with-strings/${subtopicId}`);
  };
