  ...
  const subtopics = [
    {
        ...
        "title": "Purpose and areas of application of Java",
        "description": "Understanding where Java is used and why it's popular"
    },
    {
        "id": "platform-independence",
        "title": "Principles of platform independence",
        "description": "Learn how Java achieves \"write once, run anywhere\""
    },
    {
        "id": "java-ecosystem",
        "title": "Components of the Java ecosystem",
        "description": "JVM, JDK, JRE and their relationships"
    }
];

  const handleSubtopicClick = (subtopicId: string) => {
    navigate(`/learn/java/introduction-to-java/${subtopicId}`);
  };
