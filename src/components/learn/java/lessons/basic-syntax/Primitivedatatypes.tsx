...
export default function Primitivedatatypes() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/basic-syntax/variables-and-constants');
  };

  const handleBackToTopic = () => {
    navigate('/learn/java/basic-syntax');
  };
    ...
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          ...
          >
            int, double, boolean, char and other basic types
          </div>
        </div>
