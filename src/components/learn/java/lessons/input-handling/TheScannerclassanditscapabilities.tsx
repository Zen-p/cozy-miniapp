...
export default function TheScannerclassanditscapabilities() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/input-handling/reading-console-input');
  };
  ...
  if (isMobile) {
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          The Scanner class and its capabilities
        </div>
