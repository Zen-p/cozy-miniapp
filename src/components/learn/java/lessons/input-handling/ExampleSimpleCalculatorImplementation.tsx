...
export default function ExampleSimpleCalculatorImplementation() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/errors-and-debugging/error-types');
  };

  const handleBackToTopic = () => {
    navigate('/learn/java/input-handling');
  };
  ...
  if (isMobile) {
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          Example: simple calculator implementation
        </div>
