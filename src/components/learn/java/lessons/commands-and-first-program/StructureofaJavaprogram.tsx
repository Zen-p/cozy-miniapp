...
export default function StructureofaJavaprogram() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/commands-and-first-program/class-and-main-method');
  };

  const handleBackToTopic = () => {
    navigate('/learn/java/commands-and-first-program');
  };
    ...
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          ...
          >
            Understanding the basic structure of Java programs
          </div>
        </div>
