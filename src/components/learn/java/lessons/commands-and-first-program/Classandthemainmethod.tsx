...
export default function Classandthemainmethod() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/commands-and-first-program/console-output');
  };
    ...
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          ...
          >
            Learn about classes and the main entry point
          </div>
        </div>
