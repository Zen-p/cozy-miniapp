...
export default function Featuresandlimitationsofarrays() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/methods/method-structure');
  };

  const handleBackToTopic = () => {
    navigate('/learn/java/arrays');
  };
  ...
  if (isMobile) {
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          Features and limitations of arrays
        </div>
        ...
        >
          ...
          >
            Understanding array constraints
          </div>
        </div>
