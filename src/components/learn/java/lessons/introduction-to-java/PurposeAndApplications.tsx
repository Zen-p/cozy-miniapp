...
export default function PurposeAndApplications() {
    ...
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          ...
          >
            This lesson covers the purpose and areas of application of Java programming language. 
            You'll learn about Java's versatility, its use in enterprise applications, mobile development, 
            web applications, and embedded systems. Understanding Java's broad applicability will help 
            you appreciate why it remains one of the most popular programming languages today.
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '0 18px' }}>
          ...
          >
            Next Lesson: Platform Independence
          </button>
