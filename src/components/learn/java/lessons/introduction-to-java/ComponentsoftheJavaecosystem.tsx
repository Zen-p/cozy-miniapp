...
export default function ComponentsoftheJavaecosystem() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/setting-up-workspace/installing-jdk');
  };
  ...
  if (isMobile) {
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          Components of the Java ecosystem
        </div>
        ...
        >
          ...
          >
            JVM, JDK, JRE and their relationships
          </div>
        </div>
