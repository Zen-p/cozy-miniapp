...
export default function Concatenationandperformanceconsiderations() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/working-with-strings/stringbuilder-and-buffer');
  };

  const handleBackToTopic = () => {
    navigate('/learn/java/working-with-strings');
  };
  ...
  if (isMobile) {
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          Concatenation and performance considerations
        </div>
