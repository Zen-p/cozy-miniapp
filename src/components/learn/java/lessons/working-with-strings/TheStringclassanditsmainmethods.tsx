...
export default function TheStringclassanditsmainmethods() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/working-with-strings/string-immutability');
  };
  ...
  if (isMobile) {
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          The String class and its main methods
        </div>
