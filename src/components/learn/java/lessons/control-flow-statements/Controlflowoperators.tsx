...
export default function Controlflowoperators() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/control-flow-statements/break-in-nested-loops');
  };

  const handleBackToTopic = () => {
    navigate('/learn/java/control-flow-statements');
  };
