...
export default function Compilationandprogramexecution() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/commands-and-first-program/program-structure');
  };
    ...
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          ...
          >
            Compile and run your first Java programs
          </div>
        </div>
