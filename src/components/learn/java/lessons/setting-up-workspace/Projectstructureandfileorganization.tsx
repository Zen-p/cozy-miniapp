...
export default function Projectstructureandfileorganization() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/setting-up-workspace/compilation-and-execution');
  };
    ...
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          ...
          >
            Learn proper Java project organization
          </div>
        </div>
