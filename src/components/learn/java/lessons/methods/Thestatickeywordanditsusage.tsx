...
export default function Thestatickeywordanditsusage() {
  ...
  const handleNextLesson = () => {
    navigate('/learn/java/methods/method-variable-scope');
  };

  const handleBackToTopic = () => {
    navigate('/learn/java/methods');
  };
  ...
  if (isMobile) {
    return (
      <div style={{ paddingTop: 90, margin: 0 }}>
        ...
        >
          The static keyword and its usage
        </div>
